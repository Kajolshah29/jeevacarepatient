  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* BANNER */}
        <DoctorAdBanner style={styles.adbanner} type='pharmacy'/>
        <UploadPrescription/>
        <PharmacyCategory/>
  ...
  facilities={[
    {
      ...
      specialization: 'Prescription, Over-the-Counter',
      rating: 4.5,
...
<PharmacyProducts 
  ...
  onProductPress={(product) => router.push(`/screens/productdetail?id=${product.id}` as any)}
/>
